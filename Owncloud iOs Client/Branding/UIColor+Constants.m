...
+ (UIColor*)colorOfNavigationBar{
    return [UIColor colorWithRed:45/255.0f green:133/255.0f blue:73/255.0f alpha:1.0];
}
...
+ (UIColor*)colorOfBackgroundToolBarImage {
    return [UIColor colorWithRed:45/255.0f green:133/255.0f blue:73/255.0f alpha:0.7];
}
